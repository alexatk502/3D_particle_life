...
export const simulation_conserve_momentum: (a: number) => number;
...
export const simulation_rest_density: (a: number, b: number) => number;
export const simulation_rest_density_ptr: (a: number) => number;
export const simulation_set_conserve_momentum: (a: number, b: number) => void;
...
export const simulation_set_gravity: (a: number, b: number, c: number, d: number) => void;
...
export const simulation_set_rest_density: (a: number, b: number, c: number) => void;
export const simulation_set_viscosity: (a: number, b: number) => void;
export const simulation_set_wall_damping: (a: number, b: number) => void;
export const simulation_set_walls: (a: number, b: number) => void;
...
export const simulation_walls: (a: number) => number;
